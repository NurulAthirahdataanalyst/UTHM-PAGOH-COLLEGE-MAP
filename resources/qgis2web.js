...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 20, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:4326',
            //extent: [102.726117, 2.143412, 102.729503, 2.146838],
            units: 'degrees'})
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([102.726117, 2.143412, 102.729503, 2.146838], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">UTHM PAGOH CAMPUS & COLLEGE MAP</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (48 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Metadata Description:UTHM Pagoh Campus & College';
            }
